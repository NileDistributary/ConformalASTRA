...
## 🧪 Environment Setup
For this project, we made use of the Conda package and environment management system and it is advisable that you begin by first installing [**Miniconda**](https://www.anaconda.com/download/success) or Anaconda to use it as well.
